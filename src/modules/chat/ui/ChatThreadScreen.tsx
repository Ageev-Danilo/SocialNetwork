    ...
    return (
        <Svg width={40} height={40} viewBox="0 0 40 40" fill="none">
            ...
            <Path
                ...
                stroke="#543C52" strokeWidth={1.66667} strokeLinecap="round" strokeLinejoin="round"
            />
            <Path
...
const styles = StyleSheet.create({
    ...
    topBar:               { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 10, backgroundColor: CHAT_COLORS.cardBg, borderBottomWidth: 1, borderBottomColor: CHAT_COLORS.border, gap: 8 },
    iconBtn:              { width: 40, height: 40, justifyContent: 'center', alignItems: 'center' },
    headerAvatar:         { width: 44, height: 44, borderRadius: 22 },
    headerAvatarInitials: { backgroundColor: CHAT_COLORS.highlight, justifyContent: 'center', alignItems: 'center' },
    headerInitialsText:   { fontSize: 14, fontWeight: '700', color: CHAT_COLORS.primary },
    headerInfo:           { flex: 1 },
    headerTitle:          { fontSize: 17, fontWeight: '700', color: CHAT_COLORS.text },
    headerSubtitle:       { fontSize: 13, color: CHAT_COLORS.textMuted },
    messagesList:         { paddingHorizontal: 16, paddingVertical: 16, gap: 12 },
    dateWrap:             { alignItems: 'center', marginVertical: 8 },
    dateBox:              { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 12, backgroundColor: CHAT_COLORS.dateBg },
    ...
    bubbleMine:           { maxWidth: '78%', backgroundColor: CHAT_COLORS.bubbleMine, borderRadius: 16, borderBottomRightRadius: 4, paddingHorizontal: 14, paddingVertical: 10, gap: 4 },
    ...
    inputField:           { flex: 1, borderWidth: 1, borderColor: CHAT_COLORS.border, borderRadius: 24, paddingHorizontal: 16, paddingVertical: 12, backgroundColor: CHAT_COLORS.cardBg, fontSize: 15, color: CHAT_COLORS.text, maxHeight: 100 },
