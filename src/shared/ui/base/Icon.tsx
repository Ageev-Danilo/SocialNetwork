...
export function Icon({ name, size = 24, fill, stroke, style }: IconProps) {
    const Svg = icons[name];
    return <Svg width={size} height={size} fill={fill ? fill : 'none'} stroke={stroke ? stroke : 'none'} style={style} />;
}
